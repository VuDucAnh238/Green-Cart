    ...
    return (
        <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSubmitHandle} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <button className="px-8 py-2.5 bg-primary text-white font-medium rounded cursor-pointer hover:bg-primary/80 active:bg-primary/90 transition-all duration-300 md:text-lg text-sm">ADD</button>
            </form>
        </div>
    );
};
